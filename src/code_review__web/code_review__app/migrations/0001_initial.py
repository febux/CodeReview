    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_reviewed', models.CharField(choices=[('reviewed_ok', 'Reviewed successfully'), ('reviewed_not_ok', 'Reviewed with errors'), ('not_reviewed_new', 'Not reviewed (New)'), ('not_reviewed_updated', 'Not reviewed (Updated)'), ('in_review', 'In review')], default='not_reviewed_new', verbose_name='Review state')),
